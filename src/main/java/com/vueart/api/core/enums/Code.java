...
public class Code {
    ...
    public enum ErrorCode {
        ...
        ALREADY_DELETED_CATEGORY(404,"FAVORITE_CATEGORY_ALREADY_DELETED", "이미 삭제된 즐겨찾기입니다."),
        ALREADY_REGISTERED_CATEGORY(409,"FAVORITE_CATEGORY_ALREADY_EXISTS", "이미 등록된 즐겨찾기입니다."),
